<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Booking.aspx.cs" Inherits="ClinicFront.Booking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="#">Book New Appointments</a>
        </li>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form runat="server">
                            ...
                            <asp:Button ID="book" runat="server" Text="BOOK" OnClick="Booking_submit" />
